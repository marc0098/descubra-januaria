 ...
 * 
 * Exibe um roteiro turístico exclusivo de 2 dias pelo Vale do Peruaçu.
 * Contém informações sobre duração, distância, o que levar e programação diária.
 */
      ...
      <main className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-10 md:py-14 lg:py-16 xl:py-20">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-10 md:mb-14">
          <div className="bg-white rounded-2xl p-5 shadow-md border border-gray-100 flex items-center gap-4">
            ...
            <div>
              <p className="font-sans text-xs text-gray-500 uppercase tracking-wider">Duração</p>
              <p className="font-sans font-bold text-primary">2 dias</p>
            </div>
          </div>
          <div className="bg-white rounded-2xl p-5 shadow-md border border-gray-100 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-quaternary/10 flex items-center justify-center">
            ...
            <div>
              <p className="font-sans text-xs text-gray-500 uppercase tracking-wider">Distância</p>
              <p className="font-sans font-bold text-primary">450 km</p>
            </div>
          </div>
          <div className="bg-white rounded-2xl p-5 shadow-md border border-gray-100 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-quaternary/10 flex items-center justify-center">
            ...
            <div>
              <p className="font-sans text-xs text-gray-500 uppercase tracking-wider">Atrações</p>
              <p className="font-sans font-bold text-primary">8 pontos</p>
            </div>
          </div>
          <div className="bg-white rounded-2xl p-5 shadow-md border border-gray-100 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-quaternary/10 flex items-center justify-center">
            ...
            <div>
              <p className="font-sans text-xs text-gray-500 uppercase tracking-wider">Dificuldade</p>
              <p className="font-sans font-bold text-primary">Moderada</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 md:mb-14">
          <h2 className="font-headline text-2xl md:text-3xl lg:text-4xl font-bold text-primary mb-6 uppercase">Sobre o Roteiro</h2>
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-lg border border-gray-100">
            <p className="font-sans text-primary/80 text-base md:text-lg leading-relaxed mb-6">
            ...
            <p className="font-sans text-primary/80 text-base md:text-lg leading-relaxed">
        ...
        {/* Seção: O que Inclui */}
        <section className="mb-10 md:mb-14">
          <h2 className="font-headline text-2xl md:text-3xl lg:text-4xl font-bold text-primary mb-6 md:mb-8 uppercase">O que Inclui</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-2xl p-5 md:p-6 shadow-md border border-gray-100 flex items-center gap-4">
                ...
                <span className="font-sans text-primary text-sm md:text-base">{item.text}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-10 md:mb-14">
          <h2 className="font-headline text-2xl md:text-3xl lg:text-4xl font-bold text-primary mb-6 md:mb-8 uppercase">Programação</h2>
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-lg border border-gray-100">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="font-headline text-xl md:text-2xl font-bold text-primary uppercase">Dia 1 - A Magia das Cavernas</h3>
              </div>
              <ul className="space-y-3 ml-16">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="font-sans text-primary/80">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-lg border border-gray-100">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="font-headline text-xl md:text-2xl font-bold text-primary uppercase">Dia 2 - Trilhas e História</h3>
              </div>
              <ul className="space-y-3 ml-16">
                {[
        ...
        <section className="mb-10 md:mb-14">
          <h2 className="font-headline text-2xl md:text-3xl lg:text-4xl font-bold text-primary mb-6 md:mb-8 uppercase">O que Levar</h2>
        ...
        <section className="bg-primary rounded-3xl p-6 md:p-10 text-center">
          ...
          <p className="font-sans text-white/80 text-base md:text-lg mb-8 max-w-2xl mx-auto">
            Entre em contato para verificar disponibilidade e agendar seu roteiro personalizado com nossos guias.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              className="bg-white text-primary font-sans font-bold py-4 px-8 rounded-full hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
